...
#> Nuisance parameters
#>        mean    sd lower upper
#> sigma 1.542 0.025 1.506 1.569
#> 
#> Predictor usage
#> Splitting rules per draw, and how often used at all.
#>        mean    sd lower upper prop_used
#> rhc    1.80 1.161     1   3.1      1.00
#> aps    2.56 1.343     1   4.0      1.00
#> surv2m 6.48 2.358     4  10.0      1.00
#> age    0.92 1.175     0   2.0      0.54
#> crea   0.78 0.910     0   2.0      0.54
#> meanbp 0.72 0.970     0   2.0      0.42
#> resp   0.82 1.438     0   3.0      0.28
#> edu    0.16 0.370     0   1.0      0.16
#> paco2  0.10 0.303     0   0.1      0.10
#> hema   0.06 0.314     0   0.0      0.04
#> pafi   0.02 0.141     0   0.0      0.02
#> card   0.02 0.141     0   0.0      0.02
#> sex    0.00 0.000     0   0.0      0.00
#> race   0.00 0.000     0   0.0      0.00
```
