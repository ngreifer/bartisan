...
hand sets five settings to improve effect estimation: the effect gets a
...
surface, `sparsity = FALSE` for the reason in the section above, and a
binary treatment's coding is drawn rather than fixed, so the answer does
not depend on which arm was written as 1.
