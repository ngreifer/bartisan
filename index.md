...
default, in the manner of Linero and Yang (2018), which fits a smoother
function than the step functions of standard BART.
...
a model to it takes one call, and the family is the one
[`glm()`](https://rdrr.io/r/stats/glm.html) would be given:
